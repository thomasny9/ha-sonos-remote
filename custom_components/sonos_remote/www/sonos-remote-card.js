class SonosRemoteCard extends HTMLElement {
  ...
  _render() {
    ...
    <style>
      ...
      .controls{display:grid;grid-template-columns:1fr 1fr 1.2fr 1fr 1fr;align-items:center;margin:8px 18px 5px}
      ...
      .volume{display:grid;grid-template-columns:28px 1fr 38px;gap:8px;align-items:center;margin:0 18px 7px}.volume input{width:100%}
      .group{margin:0 18px 8px;padding:9px 14px;border-radius:14px;background:#202124;cursor:pointer}.group small{display:block;color:var(--secondary-text-color);margin-bottom:3px}
