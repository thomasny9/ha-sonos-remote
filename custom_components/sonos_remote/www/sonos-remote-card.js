class SonosRemoteCard extends HTMLElement {
  ...
  _render() {
    ...
    <style>
      ...
      button{appearance:none;border:0;background:none;color:inherit;min-height:48px;cursor:pointer}.main{width:68px;height:68px;border:1px solid var(--divider-color);border-radius:50%;justify-self:center;font-size:27px}.skip{font-size:25px}
