class SonosRemoteCard extends HTMLElement {
  ...
  _render() {
    ...
    this.shadowRoot.querySelector("#openma")?.addEventListener("click",e=>{e.stopPropagation();this._openMusicAssistant();});
    this.shadowRoot.querySelector("#fixedopen")?.addEventListener("click",e=>{e.stopPropagation();this._settingsOpen=!this._settingsOpen;this._render();});
...
console.info("%c SONOS REMOTE %c v0.4.0 ","color:white;background:#03a9f4;font-weight:bold","color:#03a9f4;background:white");
